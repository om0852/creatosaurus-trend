      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <main className="md:col-span-8 lg:col-span-9">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-lg font-semibold"> Trends Results</h3>
                          ...
                          <table className="w-full text-sm table-fixed">
                            <thead>
                              <tr className="text-left text-xs text-muted-foreground">
                                ...
                                <th className="py-2 w-28">Volume</th>
                              </tr>
                            </thead>
                            <tbody>
                              {item.trending_searches.map((t, idx) => (
                                <tr key={idx} className="border-b last:border-b-0">
                                  <td className="py-2 pr-4 text-muted-foreground align-top">{t.rank}</td>
                                  <td className="py-2 align-top">
                                    <div className="font-medium">{t.term}</div>
                                
                                  </td>
                                  <td className="py-2 text-xs text-muted-foreground align-top">{t.trend_volume ?? '—'}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
